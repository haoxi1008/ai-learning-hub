...
export default function ArticlePage() {
  ...
  if (loading) {
    return (
      <div style={baseStyle}>
        <Header />
        <div style={{ textAlign: 'center', padding: '6rem', color: '#888888', fontSize: '0.875rem', letterSpacing: '0.05em' }}>
          載入中...
        </div>
        <Footer />
      </div>
    ...
    return (
      <div style={baseStyle}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '5rem 1.5rem', textAlign: 'center' }}>
          <div style={{ fontSize: '0.6875rem', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#c00000', marginBottom: '1rem' }}>
            找不到文章
          </div>
          <p style={{ color: '#888888', fontSize: '0.875rem', marginBottom: '2rem' }}>此文章不存在或已被移除。</p>
          <Link href="/" style={{ fontSize: '0.75rem', fontWeight: '700', color: '#1a1a1a', letterSpacing: '0.08em', textTransform: 'uppercase', textDecoration: 'none', borderBottom: '2px solid #1a1a1a', paddingBottom: '0.125rem' }}>
            返回首頁
          </Link>
        </div>
        <Footer />
  ...
  return (
    <div style={baseStyle}>
      ...
      <main style={{ maxWidth: '760px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        ...
        {/* CTA */}
        <div style={{ borderTop: '1px solid #e5e5e5', paddingTop: '2.5rem', textAlign: 'center' }}>
          <p style={{ fontSize: '0.8125rem', color: '#888888', marginBottom: '1.75rem', lineHeight: '1.6' }}>
            此為摘要翻譯，完整內容請至 Anthropic 官方部落格閱讀原文。
          </p>
          <a
            href={article.url}
            target="_blank"
